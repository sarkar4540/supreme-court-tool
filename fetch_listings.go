...
func main() {
	...
	req, err = http.NewRequest("POST", "https://main.sci.gov.in/php/display/get_board.php?ctype=c", nil)
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	columnnames := "Court;;;Sr.No.;Case No.;Petitioner;Respondent"
	_, err = fmt.Fprintf(w, columnnames+"\n"+delimited)
